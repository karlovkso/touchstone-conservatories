...
export default function Feedback() {
  ...
  const carouselItems = [
    {
      ...
      rating: 5,
      content: 'Chris rescued our designed conservatory project from a no-go to a go-forward. From that point on Chris and his team achieved timeline goals. Chris’ communication about project progress was excellent as was his transparency concerning emerging difficulties.',
    },
    {
  ...
  return (
    <section id="Feedback" className="py-20">
      <h1 className="text-black text-center text-4xl mb-5">What Our Customers Say</h1>
      <div className="carousel-items flex overflow-x-hidden space-x-4 sm:space-x-8 justify-center">
        {orderedItems.map((item, index) => (
          <div
            key={index}
            className={`carousel-item flex-shrink-0 w-full lg:w-1/3 p-4 transition-all duration-500 ease-in-out ${index === 3 ? 'hidden' : ''}`}
          >
